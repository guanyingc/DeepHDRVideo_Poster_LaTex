...
\headerbox{\bf\color{\headercolor} Method}{name=abstract,column=0,below=contribution,span=2}{
    ...
    \begin{minipage}[t]{0.42\linewidth}
        ...
        {\scriptsize We replace the CRF of the input images with a fixed gamma curve as $\ldr_i = (\crf^{-1} (\originldr_i))^{1/\gamma}$, where $\gamma=2.2$. Global alignment is then performed using a similarity transformation to compensate camera motions among neighboring frames.}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.54\linewidth}
        \textbf{\color{\subheadercolor}Extension to Handle Three Exposures}
        \vspace{-0.4em}
        \begin{center}
            \includegraphics[width=\textwidth]{images/three_exposure_network-crop.pdf}
        \end{center}
    \end{minipage}
...
%
\headerbox{\bf\color{\headercolor} Real-world Dataset}{name=dataset,column=2,row=0,span=3}{
    \begin{minipage}[t]{0.44\linewidth}
        ...
        \end{center}
        \vspace{-1em}
        \textbf{\color{\subheadercolor}Generating the LDRs-HDR Pairs for Dynamic Scenes.}
        \vspace{-0.7em}
        \begin{center}
            \includegraphics[width=0.87\textwidth]{images/dynamic_gt_preparation-crop.pdf}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.54\linewidth}
        ...
        \vspace{-0.6em}
        \begin{center}
            \includegraphics[width=0.88\textwidth]{images/static_samples-crop.pdf}
        \end{center}
        \vspace{-1em}
        \textbf{\color{\subheadercolor}Samples in Dynamic Scenes Without GT}
        \vspace{-0.7em}
        \begin{center}
            \includegraphics[width=0.88\textwidth]{images/dynamic_nogt_samples-crop.pdf}
        \end{center}
    \end{minipage}
